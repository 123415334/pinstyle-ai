...
function isMicroGrainStyle(styleSchema = {}) {
  ...
  return /\b(micro[-\s]?grain|fine grain|grainy|noise texture|grain texture|dither|dithered|stipple|stippled|speckle|speckled|halftone|airbrush|airbrushed|soft grain|texture overlay)\b/.test(styleText);
}
